...
- icon: envelope
  icon_pack: fas
  link: "mailto: roni.setton@mail.mcgill.ca"  # For a direct email link, use "mailto:test@example.org".
- icon: twitter
  icon_pack: fab
  link: https://twitter.com/r_setton
# - icon: google-scholar
#  icon_pack: ai
...
Forest frolicking | Hobby jogging | Baking 
